...
#ifndef __nimble_renderdevice_opengl_arraybuffer_h__
#define __nimble_renderdevice_opengl_arraybuffer_h__
...
namespace nimble{
	namespace renderdevice{
        namespace opengl{
            ...
            friend class nimble::renderdevice::opengl::IndexBuffer;
            friend class nimble::renderdevice::opengl::VertexBuffer;
            friend class nimble::renderdevice::opengl::Texture;
            private:
