...
#ifndef __nimble_renderdevice_opengl_texture_h__
#define __nimble_renderdevice_opengl_texture_h__
...
#define GLTEXTURE_TUPLESET \
GLTEXTURE_TUPLE(GL_RGB,                    GL_RGBA8,                    GL_UNSIGNED_BYTE,       sizeof(char) * 3) \
GLTEXTURE_TUPLE(GL_RGB,                    GL_RGBA16,                   GL_UNSIGNED_SHORT,      sizeof(short) * 3) \
GLTEXTURE_TUPLE(GL_RGB,                    GL_RGB,                      GL_FLOAT,               sizeof(float) * 3) \
\
GLTEXTURE_TUPLE(GL_RGBA,                   GL_RGBA8,                    GL_UNSIGNED_BYTE,       sizeof(char) * 4) \
GLTEXTURE_TUPLE(GL_RGBA,                   GL_RGBA16,                   GL_UNSIGNED_SHORT,      sizeof(short) * 4) \
GLTEXTURE_TUPLE(GL_RGBA,                   GL_RGBA,                     GL_FLOAT,               sizeof(float) * 4) \
\
GLTEXTURE_TUPLE(GL_BGR,                    GL_RGB8,                     GL_UNSIGNED_BYTE,       sizeof(char) * 3) \
GLTEXTURE_TUPLE(GL_BGRA,                   GL_RGBA8,                    GL_UNSIGNED_BYTE,       sizeof(char) * 4) \
\
GLTEXTURE_TUPLE(GL_DEPTH_COMPONENT16,      GL_DEPTH_COMPONENT16,        GL_UNSIGNED_SHORT,      sizeof(short) * 2) \
GLTEXTURE_TUPLE(GL_DEPTH_COMPONENT24,      GL_DEPTH_COMPONENT24,        GL_UNSIGNED_SHORT,      sizeof(short) * 3) \
GLTEXTURE_TUPLE(GL_DEPTH_COMPONENT32,      GL_DEPTH_COMPONENT32,        GL_UNSIGNED_SHORT,      sizeof(short) * 4)
	...
	namespace renderdevice{
        namespace opengl{
            ...
            private:
                ...
                renderdevice::opengl::ArrayBuffer   m_arrayBuffer;
