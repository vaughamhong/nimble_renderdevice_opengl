...
#ifndef __nimble_renderdevice_opengl_shaderparamblock_h__
#define __nimble_renderdevice_opengl_shaderparamblock_h__
	...
	namespace renderdevice{
        ...
        namespace opengl{
            ...
            private:
                ...
                typedef std::vector<renderdevice::opengl::ShaderParam> ParamList;
            ...
            public:
                ...
                ShaderParamBlock();
                //! Constructor
                ShaderParamBlock(renderdevice::opengl::ShaderParamBlock const &block);
                //! Destructor
